"use strict";(()=>{var e={};e.id=475,e.ids=[475],e.modules={3524:e=>{e.exports=require("@prisma/client")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},7261:e=>{e.exports=require("node:util")},845:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>l,patchFetch:()=>p,requestAsyncStorage:()=>U,routeModule:()=>A,serverHooks:()=>c,staticGenerationAsyncStorage:()=>d});var T={};a.r(T),a.d(T,{GET:()=>L,POST:()=>u});var r=a(9303),s=a(8716),E=a(670),o=a(7070),n=a(2331),i=a(9178),N=a(2957);async function L(e){try{if(await (0,N.R)(),!await (0,i.Z9)(e))return o.NextResponse.json({error:"Unauthorized"},{status:401});let t=await n._.group.findMany({include:{bots:!0},orderBy:{createdAt:"desc"}});return o.NextResponse.json({groups:t})}catch(e){return o.NextResponse.json({error:e?.message},{status:500})}}async function u(e){try{if(!await (0,i.Z9)(e))return o.NextResponse.json({error:"Unauthorized"},{status:401});let{code:t,title:a,reward:T,lore:r,coverUrl:s,status:E}=await e.json();if(!t||!a||!r)return o.NextResponse.json({error:"Код дела, название и общий лор обязательны"},{status:400});let N=await n._.group.create({data:{code:t,title:a,reward:T||"$5,000",lore:r,coverUrl:s||"https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=800&auto=format&fit=crop",status:E||"ACTIVE"}});return o.NextResponse.json({group:N})}catch(e){return o.NextResponse.json({error:e?.message},{status:500})}}let A=new r.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/groups/route",pathname:"/api/groups",filename:"route",bundlePath:"app/api/groups/route"},resolvedPagePath:"C:\\game1\\admin-panel\\app\\api\\groups\\route.ts",nextConfigOutput:"",userland:T}),{requestAsyncStorage:U,staticGenerationAsyncStorage:d,serverHooks:c}=A,l="/api/groups/route";function p(){return(0,E.patchFetch)({serverHooks:c,staticGenerationAsyncStorage:d})}},9178:(e,t,a)=>{a.d(t,{Gg:()=>N,Z9:()=>L,ed:()=>n});var T=a(6091),r=a(6176),s=a(1615);let E=new TextEncoder().encode(process.env.JWT_SECRET||"sherlock-admin-secret-key-2026-very-secure-jwt-token-alpha"),o="sherlock_admin_token";async function n(e,t="Главный следователь"){return await new T.N({email:e,name:t,role:"admin"}).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("7d").sign(E)}async function i(e){try{return(await (0,r._)(e,E)).payload}catch{return null}}async function N(){let e=(0,s.cookies)(),t=e.get(o)?.value;return t?await i(t):null}async function L(e){let t=e.cookies.get(o)?.value;if(!t){let t=e.headers.get("Authorization");return t&&t.startsWith("Bearer ")?await i(t.substring(7)):null}return await i(t)}},2331:(e,t,a)=>{a.d(t,{_:()=>r});var T=a(3524);let r=globalThis.prisma??new T.PrismaClient({log:["error"]})},2957:(e,t,a)=>{a.d(t,{R:()=>s});var T=a(2331);let r=!1;async function s(){if(!r)try{await T._.$executeRawUnsafe(`
