"use strict";(()=>{var e={};e.id=701,e.ids=[701],e.modules={3524:e=>{e.exports=require("@prisma/client")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},7261:e=>{e.exports=require("node:util")},1396:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>l,patchFetch:()=>c,requestAsyncStorage:()=>d,routeModule:()=>A,serverHooks:()=>U,staticGenerationAsyncStorage:()=>u});var T={};a.r(T),a.d(T,{GET:()=>N});var r=a(9303),s=a(8716),E=a(670),o=a(7070),n=a(2331),i=a(9178),L=a(2957);async function N(e){try{if(await (0,L.R)(),!await (0,i.Z9)(e))return o.NextResponse.json({error:"Unauthorized"},{status:401});let{searchParams:t}=new URL(e.url),a=t.get("search")||"",T=t.get("status")||"ALL",r={};"ALL"!==T&&(r.status=T),a&&(r.OR=[{username:{contains:a}},{firstName:{contains:a}},{telegramId:{contains:a}}]);let s=await n._.telegramUser.findMany({where:r,include:{dialogues:{take:5,orderBy:{createdAt:"desc"},include:{bot:!0}}},orderBy:{lastActive:"desc"}});return o.NextResponse.json({users:s})}catch(e){return o.NextResponse.json({error:e?.message},{status:500})}}let A=new r.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/users/route",pathname:"/api/users",filename:"route",bundlePath:"app/api/users/route"},resolvedPagePath:"C:\\game1\\admin-panel\\app\\api\\users\\route.ts",nextConfigOutput:"",userland:T}),{requestAsyncStorage:d,staticGenerationAsyncStorage:u,serverHooks:U}=A,l="/api/users/route";function c(){return(0,E.patchFetch)({serverHooks:U,staticGenerationAsyncStorage:u})}},9178:(e,t,a)=>{a.d(t,{Gg:()=>L,Z9:()=>N,ed:()=>n});var T=a(6091),r=a(6176),s=a(1615);let E=new TextEncoder().encode(process.env.JWT_SECRET||"sherlock-admin-secret-key-2026-very-secure-jwt-token-alpha"),o="sherlock_admin_token";async function n(e,t="Главный следователь"){return await new T.N({email:e,name:t,role:"admin"}).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("7d").sign(E)}async function i(e){try{return(await (0,r._)(e,E)).payload}catch{return null}}async function L(){let e=(0,s.cookies)(),t=e.get(o)?.value;return t?await i(t):null}async function N(e){let t=e.cookies.get(o)?.value;if(!t){let t=e.headers.get("Authorization");return t&&t.startsWith("Bearer ")?await i(t.substring(7)):null}return await i(t)}},2331:(e,t,a)=>{a.d(t,{_:()=>r});var T=a(3524);let r=globalThis.prisma??new T.PrismaClient({log:["error"]})},2957:(e,t,a)=>{a.d(t,{R:()=>s});var T=a(2331);let r=!1;async function s(){if(!r)try{await T._.$executeRawUnsafe(`
