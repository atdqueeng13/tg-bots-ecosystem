"use strict";(()=>{var e={};e.id=937,e.ids=[937],e.modules={3524:e=>{e.exports=require("@prisma/client")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},7261:e=>{e.exports=require("node:util")},1392:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>l,patchFetch:()=>I,requestAsyncStorage:()=>A,routeModule:()=>u,serverHooks:()=>c,staticGenerationAsyncStorage:()=>U});var T={};a.r(T),a.d(T,{GET:()=>L,POST:()=>d});var r=a(9303),s=a(8716),E=a(670),o=a(7070),n=a(2331),i=a(9178),N=a(2957);async function L(e){try{if(await (0,N.R)(),!await (0,i.Z9)(e))return o.NextResponse.json({error:"Unauthorized"},{status:401});let t=await n._.broadcast.findMany({orderBy:{createdAt:"desc"}});return o.NextResponse.json({broadcasts:t})}catch(e){return o.NextResponse.json({error:e?.message},{status:500})}}async function d(e){try{if(!await (0,i.Z9)(e))return o.NextResponse.json({error:"Unauthorized"},{status:401});let{message:t,audience:a,scheduledAt:T,isInstant:r}=await e.json();if(!t)return o.NextResponse.json({error:"Текст рассылки обязателен"},{status:400});let s=`BC-${Math.floor(1e3+9e3*Math.random())}`,E=await n._.telegramUser.count({where:{status:"ACTIVE"}}),N=await n._.broadcast.create({data:{code:s,message:t,audience:a||"Все Активные Пользователи",status:r?"DELIVERED":"SCHEDULED",sentCount:r?E:0,totalTarget:E,scheduledAt:T?new Date(T):null}});return o.NextResponse.json({broadcast:N})}catch(e){return o.NextResponse.json({error:e?.message},{status:500})}}let u=new r.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/broadcasts/route",pathname:"/api/broadcasts",filename:"route",bundlePath:"app/api/broadcasts/route"},resolvedPagePath:"C:\\game1\\admin-panel\\app\\api\\broadcasts\\route.ts",nextConfigOutput:"",userland:T}),{requestAsyncStorage:A,staticGenerationAsyncStorage:U,serverHooks:c}=u,l="/api/broadcasts/route";function I(){return(0,E.patchFetch)({serverHooks:c,staticGenerationAsyncStorage:U})}},9178:(e,t,a)=>{a.d(t,{Gg:()=>N,Z9:()=>L,ed:()=>n});var T=a(6091),r=a(6176),s=a(1615);let E=new TextEncoder().encode(process.env.JWT_SECRET||"sherlock-admin-secret-key-2026-very-secure-jwt-token-alpha"),o="sherlock_admin_token";async function n(e,t="Главный следователь"){return await new T.N({email:e,name:t,role:"admin"}).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("7d").sign(E)}async function i(e){try{return(await (0,r._)(e,E)).payload}catch{return null}}async function N(){let e=(0,s.cookies)(),t=e.get(o)?.value;return t?await i(t):null}async function L(e){let t=e.cookies.get(o)?.value;if(!t){let t=e.headers.get("Authorization");return t&&t.startsWith("Bearer ")?await i(t.substring(7)):null}return await i(t)}},2331:(e,t,a)=>{a.d(t,{_:()=>r});var T=a(3524);let r=globalThis.prisma??new T.PrismaClient({log:["error"]})},2957:(e,t,a)=>{a.d(t,{R:()=>s});var T=a(2331);let r=!1;async function s(){if(!r)try{await T._.$executeRawUnsafe(`
