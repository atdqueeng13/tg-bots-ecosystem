"use strict";(()=>{var e={};e.id=873,e.ids=[873],e.modules={3524:e=>{e.exports=require("@prisma/client")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},7261:e=>{e.exports=require("node:util")},7976:(e,a,t)=>{t.r(a),t.d(a,{originalPathname:()=>d,patchFetch:()=>U,requestAsyncStorage:()=>A,routeModule:()=>l,serverHooks:()=>u,staticGenerationAsyncStorage:()=>c});var T={};t.r(T),t.d(T,{POST:()=>N});var r=t(9303),s=t(8716),E=t(670),o=t(7070),n=t(9178),i=t(2331),L=t(2957);async function N(e){try{await (0,L.R)();let{email:a,password:t}=await e.json(),T=a?a.trim().toLowerCase():"",r=t?t.trim():"";if(!T||!r)return o.NextResponse.json({error:"Укажите идентификатор оперативника и код доступа."},{status:400});let s=null;try{let e=await i._.admin.findUnique({where:{email:T}});e&&e.passwordHash===r&&(s={login:e.email,name:e.name,clearanceLevel:e.clearanceLevel||4})}catch(e){console.error("DB admin check fallback to ENV:",e)}if(!s){let e=(process.env.ADMIN_EMAIL||"lasleywork").toLowerCase(),a=process.env.ADMIN_PASSWORD||"Danyap0l4ndbot615!",t=(process.env.SAINTROSE_EMAIL||"saintrose").toLowerCase(),E=process.env.SAINTROSE_PASSWORD||"roserose123";T===e&&r===a?s={login:e,name:"Главный следователь (Lasley)",clearanceLevel:4}:T===t&&r===E&&(s={login:t,name:"Следователь (SaintRose)",clearanceLevel:4})}if(!s)return o.NextResponse.json({error:"Неверный идентификатор оперативника или код доступа."},{status:401});let E=await (0,n.ed)(s.login,s.name),N=o.NextResponse.json({success:!0,user:{email:s.login,name:s.name,clearanceLevel:s.clearanceLevel,role:"admin"}});return N.cookies.set("sherlock_admin_token",E,{httpOnly:!0,secure:!0,sameSite:"lax",path:"/",maxAge:604800}),N}catch(e){return o.NextResponse.json({error:e?.message||"Внутренняя ошибка сервера"},{status:500})}}let l=new r.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/auth/login/route",pathname:"/api/auth/login",filename:"route",bundlePath:"app/api/auth/login/route"},resolvedPagePath:"C:\\game1\\admin-panel\\app\\api\\auth\\login\\route.ts",nextConfigOutput:"",userland:T}),{requestAsyncStorage:A,staticGenerationAsyncStorage:c,serverHooks:u}=l,d="/api/auth/login/route";function U(){return(0,E.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:c})}},9178:(e,a,t)=>{t.d(a,{Gg:()=>L,Z9:()=>N,ed:()=>n});var T=t(6091),r=t(6176),s=t(1615);let E=new TextEncoder().encode(process.env.JWT_SECRET||"sherlock-admin-secret-key-2026-very-secure-jwt-token-alpha"),o="sherlock_admin_token";async function n(e,a="Главный следователь"){return await new T.N({email:e,name:a,role:"admin"}).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("7d").sign(E)}async function i(e){try{return(await (0,r._)(e,E)).payload}catch{return null}}async function L(){let e=(0,s.cookies)(),a=e.get(o)?.value;return a?await i(a):null}async function N(e){let a=e.cookies.get(o)?.value;if(!a){let a=e.headers.get("Authorization");return a&&a.startsWith("Bearer ")?await i(a.substring(7)):null}return await i(a)}},2331:(e,a,t)=>{t.d(a,{_:()=>r});var T=t(3524);let r=globalThis.prisma??new T.PrismaClient({log:["error"]})},2957:(e,a,t)=>{t.d(a,{R:()=>s});var T=t(2331);let r=!1;async function s(){if(!r)try{await T._.$executeRawUnsafe(`
