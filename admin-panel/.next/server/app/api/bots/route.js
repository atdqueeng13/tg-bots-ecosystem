"use strict";(()=>{var e={};e.id=176,e.ids=[176],e.modules={3524:e=>{e.exports=require("@prisma/client")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},7261:e=>{e.exports=require("node:util")},8214:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>c,patchFetch:()=>I,requestAsyncStorage:()=>u,routeModule:()=>d,serverHooks:()=>U,staticGenerationAsyncStorage:()=>l});var T={};a.r(T),a.d(T,{GET:()=>L,POST:()=>A});var r=a(9303),s=a(8716),E=a(670),o=a(7070),n=a(2331),i=a(9178),N=a(2957);async function L(e){try{if(await (0,N.R)(),!await (0,i.Z9)(e))return o.NextResponse.json({error:"Unauthorized"},{status:401});let t=await n._.bot.findMany({include:{group:!0,_count:{select:{dialogues:!0}}},orderBy:{createdAt:"desc"}});return o.NextResponse.json({bots:t})}catch(e){return o.NextResponse.json({error:e?.message},{status:500})}}async function A(e){try{if(!await (0,i.Z9)(e))return o.NextResponse.json({error:"Unauthorized"},{status:401});let{name:t,botId:a,token:T,avatarUrl:r,role:s,groupId:E,model:N,temperature:L,reasoningEnabled:A,legend:d,knowledge:u,secrets:l,character:U,triggers:c}=await e.json();if(!t||!T)return o.NextResponse.json({error:"Имя бота и токен @BotFather обязательны"},{status:400});let I=a||`BR-${Math.floor(1e3+9e3*Math.random())}`,p=await n._.bot.create({data:{name:t,botId:I,token:T,avatarUrl:r,role:s||"Главный персонаж",groupId:E||null,model:N||"gemini-2.0-flash",temperature:void 0!==L?parseFloat(L):.7,reasoningEnabled:!!A,legend:d,knowledge:u,secrets:l,character:U,triggers:c}});return o.NextResponse.json({bot:p})}catch(e){return o.NextResponse.json({error:e?.message},{status:500})}}let d=new r.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/bots/route",pathname:"/api/bots",filename:"route",bundlePath:"app/api/bots/route"},resolvedPagePath:"C:\\game1\\admin-panel\\app\\api\\bots\\route.ts",nextConfigOutput:"",userland:T}),{requestAsyncStorage:u,staticGenerationAsyncStorage:l,serverHooks:U}=d,c="/api/bots/route";function I(){return(0,E.patchFetch)({serverHooks:U,staticGenerationAsyncStorage:l})}},9178:(e,t,a)=>{a.d(t,{Gg:()=>N,Z9:()=>L,ed:()=>n});var T=a(6091),r=a(6176),s=a(1615);let E=new TextEncoder().encode(process.env.JWT_SECRET||"sherlock-admin-secret-key-2026-very-secure-jwt-token-alpha"),o="sherlock_admin_token";async function n(e,t="Главный следователь"){return await new T.N({email:e,name:t,role:"admin"}).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("7d").sign(E)}async function i(e){try{return(await (0,r._)(e,E)).payload}catch{return null}}async function N(){let e=(0,s.cookies)(),t=e.get(o)?.value;return t?await i(t):null}async function L(e){let t=e.cookies.get(o)?.value;if(!t){let t=e.headers.get("Authorization");return t&&t.startsWith("Bearer ")?await i(t.substring(7)):null}return await i(t)}},2331:(e,t,a)=>{a.d(t,{_:()=>r});var T=a(3524);let r=globalThis.prisma??new T.PrismaClient({log:["error"]})},2957:(e,t,a)=>{a.d(t,{R:()=>s});var T=a(2331);let r=!1;async function s(){if(!r)try{await T._.$executeRawUnsafe(`
