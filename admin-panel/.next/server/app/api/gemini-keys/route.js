"use strict";(()=>{var e={};e.id=337,e.ids=[337],e.modules={3524:e=>{e.exports=require("@prisma/client")},2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},7261:e=>{e.exports=require("node:util")},5798:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>p,patchFetch:()=>m,requestAsyncStorage:()=>U,routeModule:()=>d,serverHooks:()=>l,staticGenerationAsyncStorage:()=>c});var T={};a.r(T),a.d(T,{DELETE:()=>A,GET:()=>L,POST:()=>u});var r=a(9303),s=a(8716),n=a(670),E=a(7070),i=a(2331),o=a(9178),N=a(2957);async function L(e){try{if(await (0,N.R)(),!await (0,o.Z9)(e))return E.NextResponse.json({error:"Unauthorized"},{status:401});let t=(await i._.geminiApiKey.findMany({orderBy:{createdAt:"desc"}})).map(e=>({id:e.id,name:e.name,maskedKey:e.key.length>8?`${e.key.substring(0,7)}...${e.key.substring(e.key.length-4)}`:"••••••••",status:e.status,latencyMs:e.latencyMs,requestCount:e.requestCount,lastUsedAt:e.lastUsedAt}));return E.NextResponse.json({keys:t})}catch(e){return E.NextResponse.json({error:e?.message},{status:500})}}async function u(e){try{if(!await (0,o.Z9)(e))return E.NextResponse.json({error:"Unauthorized"},{status:401});let{name:t,key:a}=await e.json();if(!a||""===a.trim())return E.NextResponse.json({error:"API ключ обязателен"},{status:400});let T=await i._.geminiApiKey.create({data:{name:t||"Gemini Secondary",key:a.trim(),status:"ACTIVE",latencyMs:120}});return E.NextResponse.json({success:!0,key:T})}catch(e){return E.NextResponse.json({error:e?.message},{status:500})}}async function A(e){try{if(!await (0,o.Z9)(e))return E.NextResponse.json({error:"Unauthorized"},{status:401});let{searchParams:t}=new URL(e.url),a=t.get("id");if(!a)return E.NextResponse.json({error:"ID обязателен"},{status:400});return await i._.geminiApiKey.delete({where:{id:a}}),E.NextResponse.json({success:!0})}catch(e){return E.NextResponse.json({error:e?.message},{status:500})}}let d=new r.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/gemini-keys/route",pathname:"/api/gemini-keys",filename:"route",bundlePath:"app/api/gemini-keys/route"},resolvedPagePath:"C:\\game1\\admin-panel\\app\\api\\gemini-keys\\route.ts",nextConfigOutput:"",userland:T}),{requestAsyncStorage:U,staticGenerationAsyncStorage:c,serverHooks:l}=d,p="/api/gemini-keys/route";function m(){return(0,n.patchFetch)({serverHooks:l,staticGenerationAsyncStorage:c})}},9178:(e,t,a)=>{a.d(t,{Gg:()=>N,Z9:()=>L,ed:()=>i});var T=a(6091),r=a(6176),s=a(1615);let n=new TextEncoder().encode(process.env.JWT_SECRET||"sherlock-admin-secret-key-2026-very-secure-jwt-token-alpha"),E="sherlock_admin_token";async function i(e,t="Главный следователь"){return await new T.N({email:e,name:t,role:"admin"}).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("7d").sign(n)}async function o(e){try{return(await (0,r._)(e,n)).payload}catch{return null}}async function N(){let e=(0,s.cookies)(),t=e.get(E)?.value;return t?await o(t):null}async function L(e){let t=e.cookies.get(E)?.value;if(!t){let t=e.headers.get("Authorization");return t&&t.startsWith("Bearer ")?await o(t.substring(7)):null}return await o(t)}},2331:(e,t,a)=>{a.d(t,{_:()=>r});var T=a(3524);let r=globalThis.prisma??new T.PrismaClient({log:["error"]})},2957:(e,t,a)=>{a.d(t,{R:()=>s});var T=a(2331);let r=!1;async function s(){if(!r)try{await T._.$executeRawUnsafe(`
